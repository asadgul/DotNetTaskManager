...
namespace TaskManager.Migrations
{
    ...
    [Migration("20240420130615_Projectclientadded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.DbModels.ClientLocation", b =>
                {
            ...
            modelBuilder.Entity("TaskManager.DbModels.ProjectLists", b =>
                {
                    b.Property<int>("ProjectID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManager.IdentityModels.ApplicationRole", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TaskManager.IdentityModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TaskManager.IdentityModels.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskManager.IdentityModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.DbModels.ProjectLists", b =>
                {
                    b.HasOne("TaskManager.DbModels.ClientLocation", "ClientLocation")
                        .WithMany()
